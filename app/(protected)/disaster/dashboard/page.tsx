...
const LoadingSpinner = () => (
  <div className="flex justify-center items-center w-full h-full">
    <div className="loader w-8 h-8 border-4 border-gray-300 border-t-blue-500 rounded-full animate-spin"></div>
  </div>
);
...
export default function Admin() {
  ...
  // States for disaster victim status
  const [
  ...
  // Total disaster victim status counts
            ...
            <div className="flex w-full gap-20 h-1/4">
              ...
              <div className="text-black flex flex-col w-1/2 items-center justify-center h-full rounded-2xl bg-[#FFF9F0]">
                ...
                <div className="flex flex-row justify-evenly h-full mt-2 mb-5 w-full">
                  <Card className="shadow-md shadow-gray-400">
                ...
                <div className="w-full h-[230px] overflow-y-auto">
                  <Table>
                    <TableHeader className="bg-slate-300">
                      <TableRow>
                        <TableHead className="w-1/5 text-gray-950 font-bold text-[15px]">
                          Type
                        </TableHead>
                        <TableHead className="w-2/5 text-gray-950 font-bold text-[15px]">
                          Latitude
                        </TableHead>
                        <TableHead className="w-2/5 text-gray-950 font-bold text-[15px]">
                          Longitude
                    ...
                    <TableBody>
                      {locationTableData.map((row, i) => (
                        <TableRow key={i}>
                          <TableCell className="text-black text-[15px]">
                            {row.type}
                          </TableCell>
                          <TableCell className="text-black text-[15px]">
                            {row.lat}
